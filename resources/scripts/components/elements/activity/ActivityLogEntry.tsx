...
import { ActivityWrapper } from '@/medusa/components/ActivityContainer';
...
export default ({ activity, children }: Props) => {
    ...
    return (
        <ActivityWrapper className='group'>
            ...
            <div className={'col-span-10 sm:col-span-9 flex'}>
                <div className={'flex-1 px-4 sm:px-0'}>
                    <div className='activity-title'>
                        ...
                        <span className='sub-title'>&nbsp;&mdash;&nbsp;</span>
                        <Link to={`#${pathTo({ event: activity.event })}`} className='link'>
                            {activity.event}
                        </Link>
                        <div className='icons'>
                            {activity.isApi && (
