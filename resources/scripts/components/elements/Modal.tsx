...
const StyledModal = styled.div`
    ${tw`p-3 sm:p-4 md:p-6 rounded-xl shadow-md overflow-y-scroll transition-all duration-150`};
    background: linear-gradient(
        to bottom right,
        ${hexToRGB(medusaColors.modal.background, 1)},
        ${hexToRGB(medusaColors.modal.background2, 1)}
    );
    border-top: 2px solid ${hexToRGB(medusaColors.modal.borderColor, 0.7)};
`;
