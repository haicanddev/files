        ...
        >
            <Form>
                <div css={tw`flex justify-between`}>
                    ...
                    <div>
                        <Button>{subuser ? 'Save' : 'Invite User'}</Button>
                    </div>
                </div>
                <FlashMessageRender byKey={'user:edit'} css={tw`mt-4`} />
                {!isRootAdmin && loggedInPermissions[0] !== '*' && (
                    <InfoBox className='px-2 py-1' textWhite>
                ...
                <div css={tw`my-6`}>
                    {Object.keys(permissions)
                        ...
                        .map((key, index) => (
                            ...
                            >
                                <DescriptionP className='text-sm mb-4'>{permissions[key].description}</DescriptionP>
